...
# ------------------------------
# Description:  epict analysis: linERR adj ses to ses countries all_excl_therap_syndrel
# ------------------------------
...
output_filename <- "ec_res_all_excl_therap_syndrel_ef_dose_cum_ses_adj_ses_count.csv"
...
formula2 <- Surv(entry_age,exit_age,all_excl_therap_syndrel)~loglin(factor(sesorig2))+lin(dose_cum)+strata(sex,country,birthcohort)
