...
# ------------------------------
# Description:  epict analysis: linERR adj ses to ses countries Myeloid
# ------------------------------
...
output_filename <- "ec_res_Myeloid_ef_dose_cum_ses_adj_ses_count.csv"
...
formula2 <- Surv(entry_age,exit_age,Myeloid)~loglin(factor(sesorig2))+lin(dose_cum)+strata(sex,country,birthcohort)
