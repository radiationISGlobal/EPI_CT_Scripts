...
# ------------------------------
# Description:  epict analysis: linERR to all cohort all_excl_therap_syndrel excluding subjects with unknown vital status
# ------------------------------
...
source("analysis_34/scripts/f_results_fit_1.r")
 
dt1 <- readRDS("transformed_cohorts/dt1_new_outcomes_v2.rds")
lag <- 2

dt1 <- dt1[dt1$statusflag==0,]

output_path     <- "analysis_34/results/"
