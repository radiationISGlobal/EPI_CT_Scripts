...
files <- list.files("analysis_UKOrigCohort/analysis_leuk_UK/results/",full.names = T)
y <- data.frame()
...
write_xlsx(y,"results/ec_res_linERR_leuk_UK_ef_dose_cum_OriginalCohort.xlsx")
