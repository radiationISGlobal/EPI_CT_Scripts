...
# ------------------------------
# Description:  NHL_Precursor_cell cumcat2_short ef all
# ------------------------------
...
output_path     <- "analysis_2_3/results/"
output_filename <- "ec_res_NHL_Precursor_cell_ef_cumcat2_short_all.xlsx"
...
temp <- dt1[dt1$n_pe==0 & dt1$NHL_Precursor_cell==1,]
...
formula <- Surv(entry_age,exit_age,NHL_Precursor_cell)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
