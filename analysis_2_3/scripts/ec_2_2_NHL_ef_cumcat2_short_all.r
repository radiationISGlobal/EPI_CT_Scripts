...
# ------------------------------
# Description:  All NHL cumcat2_short ef all
# ------------------------------
...
formula <- Surv(entry_age,exit_age,NHL)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
