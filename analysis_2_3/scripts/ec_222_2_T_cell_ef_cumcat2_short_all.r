...
# ------------------------------
# Description:  NHL_Tcell cumcat2_short ef all
# ------------------------------
...
formula <- Surv(entry_age,exit_age,NHL_Tcell)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
