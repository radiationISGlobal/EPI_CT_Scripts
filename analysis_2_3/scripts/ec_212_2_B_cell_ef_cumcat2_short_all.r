...
# ------------------------------
# Description:  NHL_Bcell cumcat2_short ef all
# ------------------------------
...
formula <- Surv(entry_age,exit_age,NHL_Bcell)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
