...
output_filename <- "ec_res_all_excl_therap_syndrel_ef_n_ct_all.csv"
outcome_name    <- "all_excl_therap_syndrel"
data_set_format <- "event_fromat"

# set the formula for the model
formula <- Surv(entry_age,exit_age,all_excl_therap_syndrel)~lin(n_ct)+strata(sex,country,birthcohort)
