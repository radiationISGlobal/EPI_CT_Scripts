...
output_filename <- "ec_res_all_excl_therap_syndrel_ef_n_ct_cat_all.csv"
...
formula <- Surv(entry_age,exit_age,all_excl_therap_syndrel)~loglin(factor(n_ct_cat))+strata(sex,country,birthcohort)
