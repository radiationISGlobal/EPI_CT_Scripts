...
output_filename <- "ec_res_Lymphoid_ef_cumcat2_short_all.csv"
...
formula <- Surv(entry_age,exit_age,Lymphoid)~loglin(factor(n_ct_cat))+strata(sex,country,birthcohort)
