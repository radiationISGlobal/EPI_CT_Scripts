...
source("analysis_15/scripts/f_results_fit_1.r")
 
dt1 <- readRDS("transformed_cohorts/dt1_new_outcomes_v2_median.rds")
lag <- 2

output_path     <- "analysis_15/results/"
...
res[length(res) + 1] <- "Median"
names(res)[length(res)] <- "Exposure"
