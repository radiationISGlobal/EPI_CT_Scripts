...
# ------------------------------
# Description:  epict analysis: linERR to all cohort Lymphoid 1 YEARS LAG
# ------------------------------
...
source("analysis_10_2/scripts/f_results_fit_1.r")

dt1 <- readRDS("transformed_cohorts/dt1_new_outcomes_v2_lag1.rds")
lag <- 1

output_path     <- "analysis_10_2/results/"
