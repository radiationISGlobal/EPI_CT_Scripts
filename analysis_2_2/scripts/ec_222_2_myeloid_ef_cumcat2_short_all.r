...
# ------------------------------
# Description:  myeloid cumcat2_short ef all
# ------------------------------
...
output_filename <- "ec_res_myeloid_ef_cumcat2_short_all.xlsx"
...
formula <- Surv(entry_age,exit_age,Myeloid)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
