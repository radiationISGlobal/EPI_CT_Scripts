...
# ------------------------------
# Description:  all_excl_therap_syndrel cumcat2_short ef all
# ------------------------------
...
output_filename <- "ec_res_all_excl_therap_syndrel_ef_cumcat2_short_all.xlsx"
...
formula <- Surv(entry_age,exit_age,all_excl_therap_syndrel)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
