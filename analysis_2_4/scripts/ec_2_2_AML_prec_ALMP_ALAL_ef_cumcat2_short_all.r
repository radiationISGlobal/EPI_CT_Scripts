...
# Table 3 - RR and 95% CI per active bone marrow dose category and ERR/100 mGy by type of myeloid neoplasm
# - analyses stratified on sex, birth cohort and country
# ------------------------------
# Description:  AML_prec_ALMP_ALAL cumcat2_short ef all
# ------------------------------
...
output_filename <- "ec_res_AML_prec_ALMP_ALAL_ef_cumcat2_short_all.xlsx"
...
temp <- dt1[dt1$n_pe==0 & dt1$AML_prec_ALMP_ALAL==1,]
...
formula <- Surv(entry_age,exit_age,AML_prec_ALMP_ALAL)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
