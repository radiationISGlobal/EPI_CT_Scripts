...
# Table 3 - RR and 95% CI per active bone marrow dose category and ERR/100 mGy by type of myelid neoplasm
# - analyses stratified on sex, birth cohort and country
# ------------------------------
# Description:  MPN_MDSMPN_MDS cumcat2_short ef all
# ------------------------------
...
output_filename <- "ec_res_MPN_MDSMPN_MDS_ef_cumcat2_short_all.xlsx"
...
temp <- dt1[dt1$n_pe==0 & dt1$MPN_MDSMPN_MDS==1,]
...
formula <- Surv(entry_age,exit_age,MPN_MDSMPN_MDS)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
