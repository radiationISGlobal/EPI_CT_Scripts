...
# ------------------------------
# Description:  MPN cumcat2_short ef all
# ------------------------------
...
formula <- Surv(entry_age,exit_age,MPN)~loglin(factor(cumcat2_short))+strata(sex,country,birthcohort)
