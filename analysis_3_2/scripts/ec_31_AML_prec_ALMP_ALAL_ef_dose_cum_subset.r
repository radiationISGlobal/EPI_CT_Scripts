...
# ------------------------------
# Description:  epict analysis: linERR to subsets cohort 
# Appendix Table 4: Linear ERR/100 mGy by type of myeloid neoplasm and by country - adjusted for age, sex, birth cohort
# ------------------------------
...
output_filename <- "ec_res_AML_prec_ALMP_ALAL_ef_dose_cum_subsets.csv"
outcome_name    <- "AML_prec_ALMP_ALAL"
...
for(i in 1:length(subsets))
{
  ...
  formula <- Surv(entry_age,exit_age,AML_prec_ALMP_ALAL)~lin(dose_cum)+strata(sex,country,birthcohort)
