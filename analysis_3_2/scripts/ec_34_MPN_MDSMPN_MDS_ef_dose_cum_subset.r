...
output_filename <- "ec_res_MPN_MDSMPN_MDS_ef_dose_cum_subsets.csv"
outcome_name    <- "MPN_MDSMPN_MDS"
...
for(i in 1:length(subsets))
{
  ...
  formula <- Surv(entry_age,exit_age,MPN_MDSMPN_MDS)~lin(dose_cum)+strata(sex,country,birthcohort)
