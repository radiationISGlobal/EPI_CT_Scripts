...
# ------------------------------
# Description:  epict analysis: linERR to subsets cohort Bcell
...
output_filename <- "ec_res_NHL_Bcell_ef_dose_cum_subsets.csv"
outcome_name    <- "NHL_Bcell"
...
for(i in 1:length(subsets))
{
  ...
  formula <- Surv(entry_age,exit_age,NHL_Bcell)~lin(dose_cum)+strata(sex,country,birthcohort)
