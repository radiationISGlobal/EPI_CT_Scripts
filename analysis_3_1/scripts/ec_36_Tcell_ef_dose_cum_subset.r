...
# ------------------------------
# Description:  epict analysis: linERR to subsets cohort NHL_Tcell
...
output_filename <- "ec_res_NHL_Tcell_ef_dose_cum_subsets.csv"
outcome_name    <- "NHL_Tcell"
...
for(i in 1:length(subsets))
{
  ...
  formula <- Surv(entry_age,exit_age,NHL_Tcell)~lin(dose_cum)+strata(sex,country,birthcohort)
